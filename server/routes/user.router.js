...
router.post('/register', (req, res, next) => {
  ...
  const patientPhoto = req.body.patientPhoto;

  const queryText = `INSERT INTO "user" (username, password, patient_name, patient_photo)
...
//   const userQueryText = `INSERT INTO "user" (username, password, patient_name, patient_photo)
//     VALUES ($1, $2, $3, $4) RETURNING id`;
//   pool
//     .query(userQueryText, [username, password, patient_name, patient_photo])
